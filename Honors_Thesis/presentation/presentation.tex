...
\usepackage{graphicx}
\graphicspath{{../../Mu_Analysis/plots/}}
...
\begin{frame}{Perfect Efficiency Curve}
        Here is a plot of the efficiency of $\textrm{L1} > 60.0 \textm{GeV}$ as a function of L1 MET\\
		\framebox{\includegraphics[height=2.65in,width=4.25in]{perfectEfficiency}}
\end{frame}
\begin{frame}{Imperfect Efficiency Curve}
        Here is a plot of the efficiency of $\textrm{L1} > 60.0 \textm{GeV}$ as a function of CELL MET\\
