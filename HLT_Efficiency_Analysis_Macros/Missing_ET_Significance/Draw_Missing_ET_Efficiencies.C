...
Bool_t Draw_Missing_ET_Efficiencies::Process(Long64_t entry)
{
   fReader.SetEntry(entry);
    ...
    if ( isMuon && isClean && Efficiency_Lib::passTransverseMassCut(metoffrecal,mexoffrecal,meyoffrecal,metoffrecalmuon,mexoffrecalmuon,meyoffrecalmuon) && ( muonActint > actintCut ) )
    {
