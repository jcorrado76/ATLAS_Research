...
// Fri Mar 23 01:40:09 2018 by ROOT version 6.13/01
// from TTree METTree/METTree
// found on file: ../data/totalntuple16.root
//////////////////////////////////////////////////////////

#ifndef JburrDuplicateCheck_h
#define JburrDuplicateCheck_h
...
class JburrDuplicateCheck : public TSelector {
public :
   ...
   JburrDuplicateCheck(TTree * /*tree*/ =0) { }
   virtual ~JburrDuplicateCheck() { }
   ...
   ClassDef(JburrDuplicateCheck,0);

};

#endif

#ifdef JburrDuplicateCheck_cxx
void JburrDuplicateCheck::Init(TTree *tree)
{
...
Bool_t JburrDuplicateCheck::Notify()
{
...
#endif // #ifdef JburrDuplicateCheck_cxx
