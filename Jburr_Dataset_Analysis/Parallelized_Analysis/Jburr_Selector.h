...
// Tue Mar 13 22:03:37 2018 by ROOT version 6.13/01
// from TTree METTree/METTree
// found on file: /home/joseph/ATLAS_Research/Curve_Reconstruction/../Jburr_Dataset_Analysis/data/totalntuple16.root
//////////////////////////////////////////////////////////

#ifndef Jburr_Selector_h
#define Jburr_Selector_h
...
class Jburr_Selector : public TSelector {
public :
   ...
   Jburr_Selector(TTree * /*tree*/ =0) { }
   virtual ~Jburr_Selector() { }
   ...
   ClassDef(Jburr_Selector,0);

};

#endif

#ifdef Jburr_Selector_cxx
void Jburr_Selector::Init(TTree *tree)
{
...
#endif // #ifdef Jburr_Selector_cxx
