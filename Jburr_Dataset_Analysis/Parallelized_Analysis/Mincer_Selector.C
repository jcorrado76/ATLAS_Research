...
// The class definition in Mincer_Selector.h has been generated automatically
...
//
// root> T->Process("Mincer_Selector.C")
// root> T->Process("Mincer_Selector.C","some options")
// root> T->Process("Mincer_Selector.C+")
//
