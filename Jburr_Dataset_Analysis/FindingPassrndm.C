...
// The class definition in FindingPassrndm.h has been generated automatically
...
//
// root> T->Process("FindingPassrndm.C")
// root> T->Process("FindingPassrndm.C","some options")
// root> T->Process("FindingPassrndm.C+")
//
