...
// Mon Mar 12 10:09:48 2018 by ROOT version 6.13/01
// from TTree METTree/METTree
// found on file: 2017analysis/totalntuple2017.root
//////////////////////////////////////////////////////////

#ifndef AlgComparison_h
#define AlgComparison_h
...
class AlgComparison : public TSelector {
public :
   ...
   AlgComparison(TTree * /*tree*/ =0) { }
   virtual ~AlgComparison() { }
   ...
   ClassDef(AlgComparison,0);

};

#endif

#ifdef AlgComparison_cxx
void AlgComparison::Init(TTree *tree)
{
