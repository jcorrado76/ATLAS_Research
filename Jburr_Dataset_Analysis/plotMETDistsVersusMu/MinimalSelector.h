...
// Tue Jun 12 12:15:08 2018 by ROOT version 6.12/06
// from TTree METTree/METTree
// found on file: ../data/totalJburrTuple.root
//////////////////////////////////////////////////////////

#ifndef MinimalSelector_h
#define MinimalSelector_h
...
class MinimalSelector : public TSelector {
public :
   ...
   MinimalSelector(TTree * /*tree*/ =0) { }
   virtual ~MinimalSelector() { }
   ...
   ClassDef(MinimalSelector,0);

};

#endif

#ifdef MinimalSelector_cxx
void MinimalSelector::Init(TTree *tree)
{
...
#endif // #ifdef MinimalSelector_cxx
