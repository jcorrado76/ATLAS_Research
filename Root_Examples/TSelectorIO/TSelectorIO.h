...
// Tue Mar 13 16:26:54 2018 by ROOT version 6.13/01
// from TTree tree/tree
// found on file: /home/joseph/ATLAS_DATA/ZeroBiasL1KF2016R307195R311481.51Runs.root
//////////////////////////////////////////////////////////

#ifndef TSelectorIO_h
#define TSelectorIO_h
...
class TSelectorIO : public TSelector {
public :
   ...
   ClassDef(TSelectorIO,0);

};

#endif

#ifdef TSelectorIO_cxx
void TSelectorIO::Init(TTree *tree)
{

   fReader.SetTree(tree);
}

Bool_t TSelectorIO::Notify()
{
