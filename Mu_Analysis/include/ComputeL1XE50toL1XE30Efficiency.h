...
public :
   ComputeL1XE50toL1XE30Efficiency(){ 
       for (int i = 0 ; i < Number_Mu_Bins; i++){
           ...
           HLT_ZB_L1XE30_MET_Distributions_by_Mubin->Add(new TH1F( Name , Title , met_dist_nbins , gevLow , gevHigh ));
           ((TH1F*)HLT_ZB_L1XE30_MET_Distributions_by_Mubin->At(i))->SetLineColor( Colors[i] );
           ...
           L1XE50_Efficiency_Fit_Objects->Add(new TF1());
