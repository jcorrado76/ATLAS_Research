...
Bool_t Jburr_Template_Selector::isHLT_zb_L1XE30(){ //{{{
    // return true if hlt noalg , l1 xe30
...
TF1* Jburr_Template_Selector::generateFitFunction(TEfficiency* teff_obj, float gevMax, float initial_slope, float initial_intercept, float initial_sigma ){//{{{
