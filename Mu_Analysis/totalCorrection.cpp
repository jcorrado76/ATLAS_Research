...
int totalCorrection(){
    ...
    ComputeL1XE30toZBEfficiency* buildl1xe30Efficiencies =
        (ComputeL1XE30toZBEfficiency*)TSelector::GetSelector("ComputeL1XE30toZBEfficiency.C");
    ...
    CorrectL1XE30toZB* correctToZB = (CorrectL1XE30toZB*) TSelector::GetSelector("CorrectL1XE30toZB.C");
    ...
    ComputeL1XE50toL1XE30Efficiency* createL1XE50Efficiencies =
        (ComputeL1XE50toL1XE30Efficiency*) TSelector::GetSelector("ComputeL1XE50toL1XE30Efficiency.C");
    ...
    CorrectL1XE50toZB* CorrectL1XE50DataAllWay = (CorrectL1XE50toZB*) TSelector::GetSelector("CorrectL1XE50toZB.C");
