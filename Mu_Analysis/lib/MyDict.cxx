...
namespace ROOT {
   ...
   static void streamer_Jburr_Template_Selector(TBuffer &buf, void *obj);
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Jburr_Template_Selector*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Jburr_Template_Selector", ::Jburr_Template_Selector::Class_Version(), "Jburr_Template_Selector.h", 28,
                  ...
                  &::Jburr_Template_Selector::Dictionary, isa_proxy, 17,
      ...
      instance.SetStreamerFunc(&streamer_Jburr_Template_Selector);
      return &instance;
   }
...
namespace ROOT {
   ...
   static void streamer_Jburr_Template_Selector(TBuffer &buf, void *obj) {
      ((::Jburr_Template_Selector*)obj)->::Jburr_Template_Selector::Streamer(buf);
   }
