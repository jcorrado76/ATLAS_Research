Int_t generateEfficiencies(TString& algA, TString& algB)
{
  /* Make 15 diagrams of 3 plots each. Make a plot of efficiency of just A to keep 10^(-4), then make a plot of efficiency of just B
  to keep 10^(-4), and then make a plot of Efficiency of the combined algorithm, keeping A and B, at the thresholds for which they keep 10^(-4) individually,
  regardless of what they keep together.
  This is the one that looks like a PPF from microeconomics */
    Float_t frac = (10**(-4)); // keeping this fraction for metcell and mht individually keeps 10^(-4) when combined
    ...
    TEfficiency* algAtEff = new TEfficiency("Algorithm A efficiency","Algorithm A efficiency",   nbins, metMin,metMax);
    TEfficiency* algBtEff = new TEfficiency("Algorithm B efficiency","Algorithm B efficiency",  nbins, metMin,metMax);
    TEfficiency* algCtEff = new TEfficiency("Algorithm C efficiency","Algorithm C efficiency",  nbins, metMin,metMax);
