{
	...
	*/
	...
	for (Int_t j = 0; j < N; j++)
	{
		...
		TString passed_hist_name = METalgArray[j];
		TString passed_hist_title = passed_hist_name;
		...
		TH2F *scatterPlot = new TH2F(teff_name + "scatter", scatterPlot_title, nscatterBinsx, scatterxmin, scatterxmax, nscatterBinsy, scatterymin, scatterymax);
		...
		scatterPlot->Draw("LEGO");


		TString newFileName = METalgArray[j] + "_analysis.root";
		f = new TFile("C:/Users/Joseph Corrado/Desktop/" + newFileName, "NEW");
