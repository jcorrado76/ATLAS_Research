{
	...
	TH1F *SumEt15L1R1 = new TH1F("SumEt15L1", "", 30, 30., 30.);
	tree->Draw("sqrt(setl1)>>SumEtL1R1", PlotCut);
	TH1F *SumEt15L1R2 = new TH1F("SumEt15L1R2", "", 30, 30., 30.);
	tree->Draw("sqrt(setl1)>>SumEt15L1R2", PlotCut1);
	TH1F *SumEt15L1R3 = new TH1F("SumEt15L1R3", "", 30, 30., 30.);
	tree->Draw("sqrt(setl1)>>SumEt15L1R3", PlotCut2);

	TH1F *SumEt15CellR1 = new TH1F("SumEt15CellL1", "", 30, 30., 30.);
	tree->Draw("sqrt(setcell)>>SumEt15CellR1", PlotCut);
	TH1F *SumEt15CellR2 = new TH1F("SumEt15CellR2", "", 30, 30., 30.);
	tree->Draw("sqrt(setcell)>>SumEtCellR2", PlotCut1);
	TH1F *SumEt15CellR3 = new TH1F("SumEt15CellR3", "", 30, 30., 30.);
	tree->Draw("sqrt(setcell)>>SumEt15CellR3", PlotCut2);

	TH1F *SumEt15MHTR1 = new TH1F("SumEt15MHTL1", "", 30, 30., 30.);
	tree->Draw("sqrt(setmht)>>SumEt15MHTR1", PlotCut);
	TH1F *SumEt15MHTR2 = new TH1F("SumEt15MHTR2", "", 30, 30., 30.);
	tree->Draw("sqrt(setmht)>>SumEt15MHTR2", PlotCut1);
	TH1F *SumEt15MHTR3 = new TH1F("SumEt15MHTR3", "", 30, 30., 30.);
	tree->Draw("sqrt(setmht)>>SumEt15MHTR3", PlotCut2);

	TH1F *SumEt15topoclR1 = new TH1F("SumEt15topoclL1", "", 30, 30., 30.);
	tree->Draw("sqrt(settopocl)>>SumEt15topoclR1", PlotCut);
	TH1F *SumEt15topoclR2 = new TH1F("SumEt15topoclR2", "", 30, 30., 30.);
	tree->Draw("sqrt(settopocl)>>SumEt15topoclR2", PlotCut1);
	TH1F *SumEt15topoclR3 = new TH1F("SumEt15topoclR3", "", 30, 30., 30.);
	tree->Draw("sqrt(settopocl)>>SumEt15topoclR3", PlotCut2);

	TH1F *SumEt15topoclpsR1 = new TH1F("SumEt15topoclpsL1", "", 30, 30., 30.);
	tree->Draw("sqrt(settopoclps)>>SumEt15topoclpsR1", PlotCut);
	TH1F *SumEt15topoclpsR2 = new TH1F("SumEt15topoclpsR2", "", 30, 30., 30.);
	tree->Draw("sqrt(settopoclps)>>SumEt15topoclpsR2", PlotCut1);
	TH1F *SumEt15topoclpsR3 = new TH1F("SumEt15topoclpsR3", "", 30, 30., 30.);
	tree->Draw("sqrt(settopoclps)>>SumEt15topoclpsR3", PlotCut2);

	TH1F *SumEt15topoclpucR1 = new TH1F("SumEt15topoclpucL1", "", 30, 30., 30.);
	tree->Draw("sqrt(settopoclpuc)>>SumEt15topoclpucR1", PlotCut);
	TH1F *SumEt15topoclpucR2 = new TH1F("SumEt15topoclpucR2", "", 30, 30., 30.);
	tree->Draw("sqrt(settopoclpuc)>>SumEt15topoclpucR2", PlotCut1);
	TH1F *SumEt15topoclpucR3 = new TH1F("SumEt15topoclpucR3", "", 30, 30., 30.);
	tree->Draw("sqrt(settopoclpuc)>>SumEt15topoclpucR3", PlotCut2);

	TH1F *SumEt15offrecalR1 = new TH1F("SumEt15offrecalL1", "", 30, 30., 30.);
	tree->Draw("sqrt(setoffrecal)>>SumEt15offrecalR1", PlotCut);
	TH1F *SumEtoffrecalR2 = new TH1F("SumEt15topocloffrecalR2", "", 30, 30., 30.);
	tree->Draw("sqrt(setoffrecal)>>SumEt15offrecalR2", PlotCut1);
	TH1F *SumEtoffrecalR3 = new TH1F("SumEt15offrecalR3", "", 30, 30., 30.);
	tree->Draw("sqrt(setoffrecal)>>SumEt15offrecalR3", PlotCut2);

	//Gather 2016 Graphics
	TFile *2016 = TFile::Open("ZeroBias2016.13Runs.root");

	TH1F *SumEt16L1R1 = new TH1F("SumEt16L1", "", 30, 30., 30.);
	tree->Draw("sqrt(setl1)>>SumEt16L1R1", PlotCut);
	TH1F *SumEt16L1R2 = new TH1F("SumEt16L1R2", "", 30, 30., 30.);
	tree->Draw("sqrt(setl1)>>SumEt16L1R2", PlotCut1);
	TH1F *SumEtL1R3 = new TH1F("SumEt16L1R3", "", 30, 30., 30.);
	tree->Draw("sqrt(setl1)>>SumEt16L1R3", PlotCut2);

	TH1F *SumEtCellR1 = new TH1F("SumCellL1", "", 30, 30., 30.);
	tree->Draw("sqrt(setcell)>>SumEtCellR1", PlotCut);
	TH1F *SumEtCellR2 = new TH1F("SumEtCellR2", "", 30, 30., 30.);
	tree->Draw("sqrt(setcell)>>SumEtCellR2", PlotCut1);
	TH1F *SumEtCellR3 = new TH1F("SumEtCellR3", "", 30, 30., 30.);
	tree->Draw("sqrt(setcell)>>SumEtCellR3", PlotCut2);

	TH1F *SumEt16MHTR1 = new TH1F("SumEt16MHTL1", "", 30, 30., 30.);
	tree->Draw("sqrt(setmht)>>SumEt16MHTR1", PlotCut);
	TH1F *SumEt16MHTR2 = new TH1F("SumEt16MHTR2", "", 30, 30., 30.);
	tree->Draw("sqrt(setmht)>>SumEt16MHTR2", PlotCut1);
	TH1F *SumEt16MHTR3 = new TH1F("SumEt16MHTR3", "", 30, 30., 30.);
	tree->Draw("sqrt(setmht)>>SumEt16MHTR3", PlotCut2);

	TH1F *SumEt16topoclR1 = new TH1F("SumEt16topoclL1", "", 30, 30., 30.);
	tree->Draw("sqrt(settopocl)>>SumEt16topoclR1", PlotCut);
	TH1F *SumEt16topoclR2 = new TH1F("SumEt16topoclR2", "", 30, 30., 30.);
	tree->Draw("sqrt(settopocl)>>SumEt16topoclR2", PlotCut1);
	TH1F *SumEt16topoclR3 = new TH1F("SumEt16topoclR3", "", 30, 30., 30.);
	tree->Draw("sqrt(settopocl)>>SumEt16topoclR3", PlotCut2);

	TH1F *SumEt16topoclpsR1 = new TH1F("SumEt16topoclpsL1", "", 30, 30., 30.);
	tree->Draw("sqrt(settopoclps)>>SumEt16topoclpsR1", PlotCut);
	TH1F *SumEt16topoclpsR2 = new TH1F("SumEt16topoclpsR2", "", 30, 30., 30.);
	tree->Draw("sqrt(settopoclps)>>SumEt16topoclpsR2", PlotCut1);
	TH1F *SumEt16topoclpsR3 = new TH1F("SumEt16topoclpsR3", "", 30, 30., 30.);
	tree->Draw("sqrt(settopoclps)>>SumEt16topoclpsR3", PlotCut2);

	TH1F *SumEt16topoclpucR1 = new TH1F("SumEt16topoclpucL1", "", 30, 30., 30.);
	tree->Draw("sqrt(settopoclpuc)>>SumEt16topoclpucR1", PlotCut);
	TH1F *SumEt16topoclpucR2 = new TH1F("SumEt16topoclpucR2", "", 30, 30., 30.);
	tree->Draw("sqrt(settopoclpuc)>>SumEt16topoclpucR2", PlotCut1);
	TH1F *SumEt16topoclpucR3 = new TH1F("SumEt16topoclpucR3", "", 30, 30., 30.);
	tree->Draw("sqrt(settopoclpuc)>>SumEt16topoclpucR3", PlotCut2);

	TH1F *SumEt16offrecalR1 = new TH1F("SumEt16offrecalL1", "", 30, 30., 30.);
	tree->Draw("sqrt(setoffrecal)>>SumEt16offrecalR1", PlotCut);
	TH1F *SumEttopocloffrecalR2 = new TH1F("SumEt16offrecalR2", "", 30, 30., 30.);
	tree->Draw("sqrt(setoffrecal)>>SumEt16offrecalR2", PlotCut1);
	TH1F *SumEttopocloffrecalR3 = new TH1F("SumEt16offrecalR3", "", 30, 30., 30.);
