...
TFile* threeEfficienciesL1( const TString& algA , const TString& algB,
        const Float_t frac = 0.00590, const TString folder = "" )
{

    //need to use the L1KF algs to do analysis. so switch files used to reflect that  
    const TString muonFileName = "../myData/ZeroBiasKF2016R307195R311481Runs51.root";
    const TString threshFileName = "../myData/PhysicsMain.L1KFmuontriggers.2016.f731f758_m1659m1710.Run309759.48Runs.root";
    userInfo* parameters = new userInfo();
    parameters->setMuonFile(threshFileName);
    parameters->setThresholdFile(muonFileName);
