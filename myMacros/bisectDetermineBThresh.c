...
std::cout << "Number of events jointly kept with B thresh at " << x1 << ": " << f1 << std::endl;
std::cout << "Number of events jointly kept with B thresh at " << x2 << ": " << f2 << std::endl;
std::cout << "Number of events jointly kept with B thresh at " << x3 << ": " << f3 << std::endl;
...
for ( j = 1 ; j <= imax ; j++)
{
  ...
  {
    cout << "Root is to the left of " << x2 << endl;
  ...
  {
    cout << "Root is to the right of " << x2 << endl;
    currentWidth = (x3 - x2) / 2.0;
    f1 = f2;
    x1 = x2;
  }

  cout << "Current width of interval: " << currentWidth << endl;
  ...
  {
    cout << "No root found, continuing bisection... " << endl;
    std::cout << "Number of events kept at old B alg threshold of " << x2 << ": " << f2 << std::endl;
    x2 = ( x1 + x3 ) / 2.0;
    cout << "New threshold " << x2 << endl;
    k = 0;
    f2 = 0;
  ...
  cout << "New number of combined events kept at " << x2 << ": " << f2 << endl;
}
